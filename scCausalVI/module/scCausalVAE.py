...
from scCausalVAE.data.utils import gram_matrix


class scCausalVAEModule(BaseModuleClass):
    """
    PyTorch module for scCausalVAE (Variational Inference).
    ...
    def __init__(
        ...
        super(scCausalVAEModule, self).__init__()
    ...
    def loss(
        ...
        """
        Compute loss terms for scCausalVAE.
        Args:
        ----
